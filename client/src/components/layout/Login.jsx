            ...
            <div className="mx-auto lg:mx-32 lg:my-8 min-h-1/2 bg-base-100 border-2 border-blue-400 lg:rounded-xl">
                <div className="flex flex-col lg:flex-row-reverse items-center justify-center gap-8 text-primary">
                    <div className="p-8 text-center hidden lg:block lg:w-[40%]">
                        ...
                        <br />
                        <a href="/auth/signup" className="my-4 px-8 btn btn-outline text-primary rounded-full">Sign up</a>
                    </div>
                    <div className="card flex-shrink-0 p-4 lg:px-8 lg:w-[60%] bg-accent bg-opacity-30 rounded-none lg:rounded-l-xl">
                        <div className="card-body">
                            ...
                            <div className="form-control gap-8">
                                ...
                                <label className="label flex flex-col lg:flex-row items-center">
                                    ...
                                    <a href="#" className="label-text a focus:outline-none a-hover">Forgot password?</a>
                                </label>
                            </div>
                            ...
                            <div className="text-primary text-center mt-4 lg:hidden">
                                <p>Don't have an account?<strong> <br /><a href="/auth/signup" className="cursor-pointer">Sign Up Instead</a></strong></p>
                            </div>
                        </div>
                    </div>
                </div>
